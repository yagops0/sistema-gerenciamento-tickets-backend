...
@Component
public class SecurityFilter extends OncePerRequestFilter {// esse filtro ocorre uma vez a cada requisição para pegar o token(tirar as informações) ou colocar oq estiver vazio
